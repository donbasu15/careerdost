      ...
      <form action={createJob} className="space-y-6">
        ...
        <div className="space-y-6 pt-4 border-t border-slate-100">
          ...
          <div>
            ...
            <RichTextEditor name="eligibility" placeholder="Requirements..." />
          </div>

          <div>
            <label className="block text-sm font-semibold text-slate-700 mb-1">Selection Process</label>
            <RichTextEditor name="selectionProcess" placeholder="Tier 1, Tier 2 exams..." />
          </div>
          ...
          <div>
            ...
            <RichTextEditor name="description" placeholder="Full job description with formatting..." />
          </div>
        </div>
