      ...
      <form action={updateJobWithId} className="space-y-6">
        ...
        <div className="space-y-6 pt-4 border-t border-slate-100">
          ...
          <div>
            ...
            <textarea required name="eligibility" defaultValue={job.eligibility} rows={3} className="w-full px-4 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 outline-none font-mono text-sm text-slate-900"></textarea>
          </div>

          <div>
            <label className="block text-sm font-semibold text-slate-700 mb-1">Selection Process</label>
            <textarea required name="selectionProcess" defaultValue={job.selectionProcess} rows={3} className="w-full px-4 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 outline-none font-mono text-sm text-slate-900"></textarea>
          </div>

          <div>
            <label className="block text-sm font-semibold text-slate-700 mb-1">How to Apply</label>
            <textarea required name="howToApply" defaultValue={job.howToApply} rows={3} className="w-full px-4 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 outline-none font-mono text-sm text-slate-900"></textarea>
          </div>

          <div>
            <label className="block text-sm font-semibold text-slate-700 mb-1">Detailed Notification / Description</label>
            <textarea required name="description" defaultValue={job.description} rows={6} className="w-full px-4 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 outline-none font-mono text-sm text-slate-900"></textarea>
          </div>
        </div>
